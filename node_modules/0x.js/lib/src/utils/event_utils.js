...
exports.eventUtils = {
    wrapEventEmitter: function (event) {
        var _this = this;
        var watch = function (eventCallback) {
            var bignumberWrappingEventCallback = exports.eventUtils._getBigNumberWrappingEventCallback(eventCallback);
            event.watch(bignumberWrappingEventCallback);
        };
        var zeroExEvent = {
            watch: watch,
            stopWatchingAsync: function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, promisify(event.stopWatching, event)()];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
     ...
     */
    _getBigNumberWrappingEventCallback: function (eventCallback) {
        var bignumberWrappingEventCallback = function (err, event) {
            if (_.isNull(err)) {
                var wrapIfBigNumber = function (value) {
                    ...
                    var isWeb3BigNumber = _.startsWith(value.constructor.toString(), 'function BigNumber(');
