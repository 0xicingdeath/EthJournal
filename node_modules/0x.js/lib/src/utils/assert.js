...
exports.assert = {
    ...
    isETHAddressHex: function (variableName, value) {
        ...
        this.assert(web3.isAddress(value) && !web3.isChecksumAddress(value), "Checksummed addresses are not supported. Convert " + variableName + " to lower case before passing");
    },
