...
var ExchangeWrapper = (function (_super) {
    ...
    ExchangeWrapper.prototype.fillOrderAsync = function (signedOrder, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var exchangeInstance, shouldValidate, _a, orderAddresses, orderValues, gas, txHash;
    ...
    ExchangeWrapper.prototype.fillOrdersUpToAsync = function (signedOrders, fillTakerTokenAmount, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var takerTokenAddresses, exchangeContractAddresses, shouldValidate, orderAddressesValuesAndSignatureArray, _a, orderAddressesArray, orderValuesArray, vArray, rArray, sArray, exchangeInstance, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        shouldValidate = _.isUndefined(orderTransactionOpts) ?
                            SHOULD_VALIDATE_BY_DEFAULT :
                            orderTransactionOpts.shouldValidate;
                        if (!shouldValidate) return [3 /*break*/, 3];
                        return [4 /*yield*/, Promise.all(signedOrders.map(function (signedOrder) { return _this.validateFillOrderThrowIfInvalidAsync(signedOrder, fillTakerTokenAmount, takerAddress); }))];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
    ...
    ExchangeWrapper.prototype.batchFillOrdersAsync = function (orderFillRequests, shouldThrowOnInsufficientBalanceOrAllowance, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var exchangeContractAddresses, shouldValidate, orderAddressesValuesAmountsAndSignatureArray, _a, orderAddressesArray, orderValuesArray, fillTakerTokenAmounts, vArray, rArray, sArray, exchangeInstance, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        shouldValidate = _.isUndefined(orderTransactionOpts) ?
                            ...
                            orderTransactionOpts.shouldValidate;
                        if (!shouldValidate) return [3 /*break*/, 3];
                        return [4 /*yield*/, Promise.all(orderFillRequests.map(function (orderFillRequest) { return _this.validateFillOrderThrowIfInvalidAsync(orderFillRequest.signedOrder, orderFillRequest.takerTokenFillAmount, takerAddress); }))];
                    case 2:
                        _b.sent();
                        _b.label = 3;
                    case 3:
    ...
    ExchangeWrapper.prototype.batchFillOrKillAsync = function (orderFillOrKillRequests, takerAddress, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var exchangeContractAddresses, exchangeInstance, shouldValidate, orderAddressesValuesAndTakerTokenFillAmounts, _a, orderAddresses, orderValues, fillTakerTokenAmounts, vParams, rParams, sParams, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        shouldValidate = _.isUndefined(orderTransactionOpts) ?
                            ...
                            orderTransactionOpts.shouldValidate;
                        if (!shouldValidate) return [3 /*break*/, 4];
                        return [4 /*yield*/, Promise.all(orderFillOrKillRequests.map(function (request) { return _this.validateFillOrKillOrderThrowIfInvalidAsync(request.signedOrder, request.fillTakerAmount, takerAddress); }))];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4:
    ...
    ExchangeWrapper.prototype.batchCancelOrdersAsync = function (orderCancellationRequests, orderTransactionOpts) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var exchangeContractAddresses, makers, maker, shouldValidate, exchangeInstance, orderAddressesValuesAndTakerTokenCancelAmounts, _a, orderAddresses, orderValues, cancelTakerTokenAmounts, gas, txHash;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        shouldValidate = _.isUndefined(orderTransactionOpts) ?
                            ...
                            orderTransactionOpts.shouldValidate;
                        if (!shouldValidate) return [3 /*break*/, 3];
                        return [4 /*yield*/, Promise.all(orderCancellationRequests.map(function (cancellationRequest) {
                                return _this.validateCancelOrderThrowIfInvalidAsync(cancellationRequest.order, cancellationRequest.takerTokenCancelAmount);
                            }))];
                    case 2:
                        _b.sent();
                        _b.label = 3;
    ...
    ExchangeWrapper.prototype.validateOrderFillableOrThrowAsync = function (signedOrder, opts) {
        return __awaiter(this, void 0, void 0, function () {
            var zrxTokenAddress, expectedFillTakerTokenAmount;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        assert_1.assert.doesConformToSchema('signedOrder', signedOrder, _0x_json_schemas_1.schemas.signedOrderSchema);
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._orderValidationUtils.validateOrderFillableOrThrowAsync(signedOrder, zrxTokenAddress, expectedFillTakerTokenAmount)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
