...
import { Order, OrderFillOrKillRequest, SignedOrder, ExchangeEvents, ContractEventEmitter, SubscriptionOpts, IndexedFilterValues, OrderCancellationRequest, OrderFillRequest, LogWithDecodedArgs, MethodOpts, ValidateOrderFillableOpts, OrderTransactionOpts } from '../types';
...
export declare class ExchangeWrapper extends ContractWrapper {
     ...
     */
    getLogsAsync(eventName: ExchangeEvents, subscriptionOpts: SubscriptionOpts, indexFilterValues: IndexedFilterValues): Promise<LogWithDecodedArgs[]>;
    /**
