...
import { TokenEvents, IndexedFilterValues, SubscriptionOpts, ContractEventEmitter, MethodOpts, LogWithDecodedArgs } from '../types';
/**
...
export declare class TokenWrapper extends ContractWrapper {
     ...
     */
    getLogsAsync(tokenAddress: string, eventName: TokenEvents, subscriptionOpts: SubscriptionOpts, indexFilterValues: IndexedFilterValues): Promise<LogWithDecodedArgs[]>;
    /**
